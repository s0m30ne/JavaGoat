...
Current coverage follows the stacks used in business systems: MyBatis dynamic SQL and JPA JPQL/dynamic sorting. The preferred fix is parameterized queries; column names, table names, sort directions, and other SQL structure elements must use enums or allowlist mappings.
